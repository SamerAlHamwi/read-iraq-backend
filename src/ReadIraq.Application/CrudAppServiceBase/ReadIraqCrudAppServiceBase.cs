...
{
    public abstract class ReadIraqCrudAppServiceBase<TEntity, TEntityDto, TPrimaryKey, TLiteEntityDto, TGetAllInput, TCreateInput, TUpdateInput>
      : ApplicationService
      ...
      where TUpdateInput : IEntityDto<TPrimaryKey>
    {
        ...
        protected ReadIraqCrudAppServiceBase(IRepository<TEntity, TPrimaryKey> repository)
        {
